...
first_interfaces__srv__AddTwoInts_Request__create(void)
{
  ...
  first_interfaces__srv__AddTwoInts_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    first_interfaces__srv__AddTwoInts_Request * data =
      (first_interfaces__srv__AddTwoInts_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!first_interfaces__srv__AddTwoInts_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          first_interfaces__srv__AddTwoInts_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
first_interfaces__srv__AddTwoInts_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ...
  first_interfaces__srv__AddTwoInts_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    first_interfaces__srv__AddTwoInts_Response * data =
      (first_interfaces__srv__AddTwoInts_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!first_interfaces__srv__AddTwoInts_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          first_interfaces__srv__AddTwoInts_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
...
bool
first_interfaces__srv__AddTwoInts_Event__init(first_interfaces__srv__AddTwoInts_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    first_interfaces__srv__AddTwoInts_Event__fini(msg);
    return false;
  }
  // request
  if (!first_interfaces__srv__AddTwoInts_Request__Sequence__init(&msg->request, 0)) {
    first_interfaces__srv__AddTwoInts_Event__fini(msg);
    return false;
  }
  // response
  if (!first_interfaces__srv__AddTwoInts_Response__Sequence__init(&msg->response, 0)) {
    first_interfaces__srv__AddTwoInts_Event__fini(msg);
    return false;
  }
  return true;
...
void
first_interfaces__srv__AddTwoInts_Event__fini(first_interfaces__srv__AddTwoInts_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  first_interfaces__srv__AddTwoInts_Request__Sequence__fini(&msg->request);
  // response
  first_interfaces__srv__AddTwoInts_Response__Sequence__fini(&msg->response);
}

bool
first_interfaces__srv__AddTwoInts_Event__are_equal(const first_interfaces__srv__AddTwoInts_Event * lhs, const first_interfaces__srv__AddTwoInts_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!first_interfaces__srv__AddTwoInts_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!first_interfaces__srv__AddTwoInts_Response__Sequence__are_equal(
...
bool
first_interfaces__srv__AddTwoInts_Event__copy(
  const first_interfaces__srv__AddTwoInts_Event * input,
  first_interfaces__srv__AddTwoInts_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!first_interfaces__srv__AddTwoInts_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!first_interfaces__srv__AddTwoInts_Response__Sequence__copy(
...
first_interfaces__srv__AddTwoInts_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  first_interfaces__srv__AddTwoInts_Event * msg = (first_interfaces__srv__AddTwoInts_Event *)allocator.allocate(sizeof(first_interfaces__srv__AddTwoInts_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(first_interfaces__srv__AddTwoInts_Event));
  bool success = first_interfaces__srv__AddTwoInts_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
first_interfaces__srv__AddTwoInts_Event__destroy(first_interfaces__srv__AddTwoInts_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    first_interfaces__srv__AddTwoInts_Event__fini(msg);
...
bool
first_interfaces__srv__AddTwoInts_Event__Sequence__init(first_interfaces__srv__AddTwoInts_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  first_interfaces__srv__AddTwoInts_Event * data = NULL;

  if (size) {
    data = (first_interfaces__srv__AddTwoInts_Event *)allocator.zero_allocate(size, sizeof(first_interfaces__srv__AddTwoInts_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = first_interfaces__srv__AddTwoInts_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        first_interfaces__srv__AddTwoInts_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
first_interfaces__srv__AddTwoInts_Event__Sequence__fini(first_interfaces__srv__AddTwoInts_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      first_interfaces__srv__AddTwoInts_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
first_interfaces__srv__AddTwoInts_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  first_interfaces__srv__AddTwoInts_Event__Sequence * array = (first_interfaces__srv__AddTwoInts_Event__Sequence *)allocator.allocate(sizeof(first_interfaces__srv__AddTwoInts_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = first_interfaces__srv__AddTwoInts_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
first_interfaces__srv__AddTwoInts_Event__Sequence__destroy(first_interfaces__srv__AddTwoInts_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    first_interfaces__srv__AddTwoInts_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
first_interfaces__srv__AddTwoInts_Event__Sequence__are_equal(const first_interfaces__srv__AddTwoInts_Event__Sequence * lhs, const first_interfaces__srv__AddTwoInts_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!first_interfaces__srv__AddTwoInts_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
first_interfaces__srv__AddTwoInts_Event__Sequence__copy(
  const first_interfaces__srv__AddTwoInts_Event__Sequence * input,
  first_interfaces__srv__AddTwoInts_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(first_interfaces__srv__AddTwoInts_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    first_interfaces__srv__AddTwoInts_Event * data =
      (first_interfaces__srv__AddTwoInts_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!first_interfaces__srv__AddTwoInts_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          first_interfaces__srv__AddTwoInts_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!first_interfaces__srv__AddTwoInts_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
