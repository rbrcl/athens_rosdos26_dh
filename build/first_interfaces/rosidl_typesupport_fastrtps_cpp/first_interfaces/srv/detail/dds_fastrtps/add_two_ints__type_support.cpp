  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = first_interfaces::srv::AddTwoInts_Request;
    is_plain =
      (
      offsetof(DataType, b) +
      last_member_size
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = first_interfaces::srv::AddTwoInts_Response;
    is_plain =
      (
...
// functions for first_interfaces::srv::AddTwoInts_Request already declared above

// functions for first_interfaces::srv::AddTwoInts_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_first_interfaces
cdr_serialize(
  const first_interfaces::srv::AddTwoInts_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      first_interfaces::srv::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  first_interfaces::srv::AddTwoInts_Event & ros_message)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      first_interfaces::srv::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        first_interfaces::srv::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        first_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_AddTwoInts_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        first_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_AddTwoInts_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = first_interfaces::srv::AddTwoInts_Event;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      first_interfaces::srv::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.request[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        first_interfaces::srv::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.request[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        first_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_AddTwoInts_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        first_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_AddTwoInts_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const first_interfaces::srv::AddTwoInts_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<first_interfaces::srv::AddTwoInts_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &first_interfaces::srv::typesupport_fastrtps_cpp::_AddTwoInts_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, first_interfaces, srv, AddTwoInts_Event)() {
  return &first_interfaces::srv::typesupport_fastrtps_cpp::_AddTwoInts_Event__handle;
}
...
static const rosidl_service_type_support_t _AddTwoInts__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<first_interfaces::srv::AddTwoInts_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<first_interfaces::srv::AddTwoInts_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<first_interfaces::srv::AddTwoInts_Event>(),
